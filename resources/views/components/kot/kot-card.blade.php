<div>
    <div @class([
                        ...
                        <tr>
                            ...
                            <td @class(['p-3 pl-0 text-right font-medium text-gray-900 dark:text-white', 'bg-green-50 dark:bg-green-800/30' => $item->status == 'ready'])>
                                ...
                                @if($kotSettings->enable_item_level_status)
                                    ...
                                    <button wire:click="changeKotItemStatus({{ $item->id }}, 'cooking')" class="p-2 text-nowrap rounded-md text-xs  text-gray-600 border border-gray-500 inline-flex items-center gap-1">
                                    ...
                                    <button wire:click="changeKotItemStatus({{ $item->id }}, 'ready')" class="p-2 text-nowrap rounded-md text-xs  text-gray-600 border border-gray-500 inline-flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
                                            <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/>
                                            <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
                                        </svg>
                                    ...
                                    @else
                                    <span class="text-lg text-green-500 inline-flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-all w-5 h-5" viewBox="0 0 16 16">
        ...
        <div class="flex justify-end gap-2">
            ...
            <button wire:click="printKot({{ $kot->id }})"
                class="inline-flex items-center justify-center rounded-md border border-skin-base bg-transparent px-4 py-2 text-sm font-medium text-skin-base transition hover:bg-skin-muted focus:outline-none focus:ring-2 focus:ring-skin-base focus:ring-offset-2">
                <svg class="h-10 w-10 text-skin-base" width="24" height="24" viewBox="0 0 24 24"
    ...
    <x-confirmation-modal wire:model="confirmDeleteKotModal">
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="ml-3" wire:click='deleteKot({{ $kot->id }})'
