<div class="mx-2 mb-4 space-y-6 md:mx-0" wire:poll.15s>
    ...
    <div class="overflow-hidden rounded-lg bg-gray-50 dark:bg-gray-800">
        <!-- Order Status Header -->
        <div class="px-6 py-4 border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            @if ($order->order_status->value === 'cancelled')
                <div class="flex items-center gap-3 text-red-600 dark:text-red-400">
                    <div class="p-2 bg-red-100 rounded-full dark:bg-red-900/30">
            ...
            @else
                ...
                <div class="relative">
                    <!-- Progress Bar -->
                    <div class="absolute left-0 hidden w-full h-1 bg-gray-200 rounded sm:block top-5 dark:bg-gray-600">
                        <div class="h-1 transition-all duration-500 rounded bg-skin-base/80 dark:bg-skin-base/90"
        ...
        <div class="p-4 mb-4 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-800">
            <!-- Order Header -->
            ...
            @if($order->order_type === 'delivery' && $order->delivery_address)
                <div class="p-3 mt-4 rounded-lg bg-skin-base/5 dark:bg-gray-700/30" wire:key="delivery-address">
                    <div class="flex items-center gap-2">
                        <svg class="flex-shrink-0 w-4 h-4 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-3 mt-4 rounded-lg bg-skin-base/15">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="relative flex-shrink-0">
                                <img class="object-cover w-16 h-16 rounded-lg shadow-sm ring-1 ring-gray-200 dark:ring-gray-700"
            ...
            <!-- Order Summary -->
            <div class="p-4 rounded-b-lg bg-gray-50 dark:bg-gray-700/50">
                <div class="space-y-3">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700" wire:key="tip-details-and-amounts">
                            <div class="flex items-center justify-between gap-4 mt-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($canAddTip)
                                        <x-button wire:click="addTipModal" class="flex items-center text-sm">
        ...
        <div class="p-4 my-4 shadow-sm bg-gray-50 dark:bg-gray-800 rounded-xl">
            <!-- Section Header -->
            ...
            @if($order->payments->count())
                <div class="mb-4 space-y-4">
                    @foreach($order->payments as $payment)
                        <div class="p-4 transition-shadow bg-white border border-gray-200 rounded-lg dark:bg-gray-700/50 dark:border-gray-600 hover:shadow-md">
                            <div class="flex items-start justify-between gap-4">
                                <!-- Payment Method Details -->
                                <div class="flex items-start gap-3">
                                    <!-- Payment Icon based on method -->
                                    <div class="p-2 bg-gray-100 rounded-full dark:bg-gray-500">
